...
The Commander MCP is built from the pinned [`safrano9999-nathanmtg`](https://github.com/safrano9999/safrano9999-nathanmtg) fork at commit `dc85b7e`, where [PR #48](https://github.com/nathanmartins/mtg-mcp/pull/48) adds optional native Streamable HTTP exposed by this image on port `8001` without a local FastMCP bridge.

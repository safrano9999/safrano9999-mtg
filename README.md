...
The Nathan Commander MCP is built unchanged from [`nathanmartins/mtg-mcp`](https://github.com/nathanmartins/mtg-mcp) at the pinned revision and is only wrapped with FastMCP as an HTTP MCP on port `8001`.
